...
class RewardTacticalClass(Dock):
    ...
    def tactical_class_receive(self, skip_first_screenshot=True):
        ...
        while 1:
            ...
            if not self.appear(TACTICAL_CLASS_CANCEL, offset=(20, 20)) and self.appear(
            ...
            if self.appear(MISSION_POPUP_GO, offset=self._popup_offset, interval=2):
                ...
                continue
            if self.appear(TACTICAL_CLASS_CANCEL, offset=(30, 30), interval=2) and self.appear(
                TACTICAL_CLASS_START, offset=(30, 30)
            ):
